  ...
  return (
    <Link to="/" className="flex items-center space-x-3 group select-none">
      ...
      <div className="flex flex-col">
        ...
        >
          <span className={isLight ? 'text-white drop-shadow-[0_1px_4px_rgba(0,0,0,0.25)]' : 'text-gray-900 drop-shadow-[0_1px_4px_rgba(0,0,0,0.10)]'}>
            Flash
          </span>
          ...
          <span className="text-yellow-400 drop-shadow-[0_0_6px_#fde047]">'</span>
        </span>
        {showTagline && (
          <span 
