...
function OrderPaymentCancel() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-rose-50/20 py-10 px-4">
        ...
        >
          ...
          <div className="p-6 space-y-5">
            <div className="rounded-2xl bg-gray-50 border border-gray-100 p-4">
              ...
              <p className="text-lg font-bold text-gray-900">{orderId || 'Reference indisponible'}</p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <button
                onClick={handleRetry}
                disabled={loading}
                className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gray-900 text-white font-semibold hover:bg-gray-800 transition disabled:opacity-60"
              >
